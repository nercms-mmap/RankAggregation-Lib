...
if is_train:
    ...
    train_fea_file = './train_feature22.mat'
    train_lab_file = './train_label22.mat'
    ...
    if not (os.path.isfile(train_fea_file) and os.path.isfile(train_lab_file)):
        ...
        fea = feature.FeatureRepresenter_3D(workers, probe, gallery, 2, 2, 2)
