...
for times = 1: num_runs
    ...
    comb_score = sum(comb_score,1);
    comb_score = comb_score * (1 / item_num);
    ...
    save('D:\Code of RA\Preflib\results\ice-cream\rank-based\rank-result-ice-cream-CombANZ.mat', 'res');
