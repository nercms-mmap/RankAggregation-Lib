...
# This score_list updates rank to score with different ways
    ...
    for i in range(num_items):
        ...
        for k in range(num_voters):
            item_min_score[k] = item_score[k,i]
# CombMNZ is selection of original rankings, in this case, is all.
